# kubernetes-learning
Repository used for learning about Kubernetes. <br> It starts with kubernetes objects and it also contains a lightweight microservices architecture (Voting App).
